...
- [Configuration](/server/configuration) — every env var, `konet.config.toml`, webhooks, metrics
- [Deployment](/server/deployment) — Coolify, Dokploy, plain VPS, TLS and proxying
- [Studio](/server/studio) — the built-in LiveView admin dashboard
